...
class Gugu {
  ...
  setup() {
    if (this.CONFIG === undefined) return Promise.reject('config error');
  ...
  print(str) {
    ...
    return Promise.resolve()
      ...
      .then(printcontent => this._request('print', { printcontent, userID: this.userID }))
      .then(d => {
